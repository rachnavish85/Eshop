        ...
        <div className='py-8'>
            ...
            lg:grid-cols-4 gap-8 '>
                    ...
                    flex items-end  '>
                        <div>
                            <div className='mb-4'>
                                ...
                                <p className='text-4xl xl:text-5xl font-bold opacity-20 mb-2'>Earephone</p>
                        ...
                        <img src={Image1} className='w-[320px] absolute 
                        bottom-0 ' />
                    </div>
                    {/*second col */}
                    ...
                    flex items-end  '>
                        ...
                        <img src={Image3} className='w-[350px] absolute top-1/2 -translate-y-1/2 -right-0
                        bottom-0 ' />
                    </div>
