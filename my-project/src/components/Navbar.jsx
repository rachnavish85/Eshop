            ...
            <div className='py-4'>
                ...
                '>
                    ...
                    <div className='flex items-center gap-4'>
                        <a href='#' className='text-primry font-semibold
                        ...
                        <div className='hidden lg:block'>
                            <ul className='flex items-center gap-4'>
                                ...
                                shadow-md dark:bg-gray-900 p-2 dark:text-white ' >
                                        ...
                                        hover:text-black dark:hover:text-wh
                                        duration-200  inline-block w-full p-2 hover:bg-primary/20 
                    ...
                    dark:text-gray-400 absolute top-1/2 -translate-y-1/2 right-3 duration-200'/>
                        ...
                        absolute top-0 right-0 flex items-center justify-center text-xs'>4
                            </div>
                        </button>
                        {/*dark mode section */}
                        <div>
